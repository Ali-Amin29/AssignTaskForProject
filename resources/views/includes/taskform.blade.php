<form action={{ URL::route('task.store') }} method="POST">
    @csrf
    <div class="mb-3">
      <label for="exampleInputName" class="form-label"><strong>Customer Name</strong> <small>Required*</small></label>
      <input type="text" name="catch" class="form-control" id="exampleInputName" >
    </div>
    <div class="mb-3">
      <label for="exampleInputSelectProj" class="form-label"><strong>Project</strong> <small>Required*</small></label>
    ...
    <div class="mb-3">
        ...
        <p>Can Assign Customer For User Or not</p>
    </div>
